            ...
            <section className="xui-py-3 xui-container">
                <div className="xui-bg-sz-cover xui-bg-pos-center xui-text-white xui-bdr-rad-2" style={{"backgroundImage": `url('${CollabImage}')`}}>
                    <div className="xui-overlay-1 xui-p-2 xui-bdr-rad-2">
                        <h1 className="xui-font-9 xui-lg-w-fluid-80 xui-w-fluid-100 xui-font-sz-250">Join And Collaborate with other Agricultural Enthusiasts.</h1>
                        <p className="xui-font-sz-80 xui-lg-w-fluid-40 xui-w-fluid-100 xui-opacity-8 xui-line-height-1-half xui-mt-half">Join our growing community of nature lovers, food enthusiasts, and sustainability advocates as we work together to create a better world, one harvest at a time.</p>
                        <div className="xui-mt-2 xui-d-flex xui-flex-jc-flex-end">
                            <form className="xui-mt-4" noValidate onSubmit={handleSubmit(sendRequest)} autoComplete="off">
                                <div className="xui-d-flex xui-bdr-rad-1-half xui-flex-ai-center xui-p-half xui-font-sz-80 xui-mt-half xui-bg-white">
