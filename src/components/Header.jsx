...
export default function Header(){
    return(
        <>
            <section className="xui-bg-sz-cover xui-bg-pos-center xui-text-white" style={{"backgroundImage": `url('${HeaderImage}')`}}>
                {/* <Navbar /> */}
                <div className="xui-h-fluid-100 xui-overlay-1 amd-header xui-container">
                    <div className="xui-lg-mt-5 xui-mt-2 xui-d-flex ">
                        <div className="xui-lg-w-250 xui-w-fluid-100">
                            <h1 className="xui-lg-font-sz-450 xui-font-9 xui-lg-pos-absolute xui-pos-static xui-z-index-1 xui-font-w-500 xui-font-sz-300 bold-font">Revolutionizing Agriculture Through Innovation</h1>
